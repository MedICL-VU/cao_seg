...
# Example usage
video_folder = "/media/hao/mydrive1/CAO_virtuoso_data/all_videos"  # Change to your folder with videos
output_folder = "/media/hao/mydrive1/CAO_virtuoso_data/all_videos_frames"  # Where frames will be saved
